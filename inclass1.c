...
int main(int argc, char** argv){
  ...
  printf("size of int+short: %lu\n", sizeof(type_int+type_short));
  printf("size of int+float: %lu\n", sizeof(type_int+type_float));
  printf("size of long+float: %lu\n", sizeof(type_long+type_float));
  printf("size of long+double: %lu\n", sizeof(type_long+type_double));
  printf("size of int+double: %lu\n", sizeof(type_int+type_double));
  printf("size of short+double: %lu\n", sizeof(type_short+type_double));
  printf("size of long+float: %lu\n", sizeof(type_long+type_float));
   printf("size of char+float: %lu\n", sizeof(type_char+type_float));
   printf("size of char+int: %lu\n", sizeof(type_char+type_int));
	...
	*/
    ...
    This is because we are getting the size of the pointer which stores the string  as unsigned long which is always 8.
	*/
